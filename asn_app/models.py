...
class SuratUndangan(models.Model):
    ...
    pembuka_surat = models.TextField(blank=True, null=True, verbose_name='Pembuka Surat')
    isi_undangan = models.TextField(blank=True, null=True, verbose_name='Isi/Maksud Undangan')
    penutup_surat = models.TextField(blank=True, null=True, verbose_name='Penutup Surat')
